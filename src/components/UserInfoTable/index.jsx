      ...
      <Row>
        <Col
          ...
          style={{
            ...
            textAlign: 'center',
            border: 'transparent',
            borderBottom: activeKeyStr === 'orders' ? '2px solid #faf7f7' : '',
        ...
        <Col
          ...
          style={{
            ...
            textAlign: 'center',
            border: 'transparent',
            borderBottom: activeKeyStr === 'fills' ? '2px solid #faf7f7' : '',
            background: 'transparent',
            fontSize: 14,
            fontStyle: 'normal',
            fontWeight: 600,
        ...
        <Col
          ...
          style={{
            ...
            border: 'transparent',
            borderBottom:
              activeKeyStr === 'balances' ? '2px solid #faf7f7' : '',
            background: 'transparent',
            fontSize: 14,
            fontStyle: 'normal',
            fontWeight: 600,
        ...
        {market && market.supportsSrmFeeDiscounts ? (
          <Col
            ...
            style={{
              ...
              textAlign: 'center',
              border: 'transparent',
              borderBottom: activeKeyStr === 'fees' ? '2px solid #faf7f7' : '',
              background: 'transparent',
              fontSize: 14,
              fontStyle: 'normal',
              fontWeight: 600,
