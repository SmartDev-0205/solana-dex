...
let _MARKETS: any = [
  ...
  { name: 'JESUS/USDC', deprecated: true, address: new PublicKey('Wjkv6mADbvuoJYER8r7w1P5zuZ8KxjNCh92Ke4AsDUy'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://arweave.net/jN2pQUmcVlxRY1E9qT8ZQDi88R9RtetBZR4CH3hNcbI', },
  { name: 'FRONK/USDC', deprecated: true, address: new PublicKey('BW9gp75QN2DgftnG1Vvu7PbP119EP4xEE5eFXXHkaiea'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://shdw-drive.genesysgo.net/8tfWzweVe7MAfi8qwiKFnzLq6wuLT7WAPMoQC7DH47Fq/fronk.png', },
  { name: 'DOGGO/USDC', deprecated: true, address: new PublicKey('9fD2u4PbBoN8y3vvAtLMpVDFw2ThPWA11PV6CcsiSnu5'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://shdw-drive.genesysgo.net/BBwXjBB6LtWGjKW5GveUSau5z9KZv2CK5AWmb7FCDF6K/doggies_coin.png', },
  { name: 'ARB/USDC', deprecated: true, address: new PublicKey('3encwsh3sx4fZVEp7i1tMR7YMkpbtcuctheqDvkvKWd2'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/ARB.png', },
  { name: 'BLOW/USDC', deprecated: true, address: new PublicKey('7oVs3vhJyyrog5BATkdbykEM94e9xdBT5M74sAPK4rMY'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/BLOW.png', },
  ...
  { name: 'BOO/USDC', deprecated: true, address: new PublicKey('ByHRAM6pcfmrqyfSJtJ3JLsrEhkmTsWk86Urt2sjXZWo'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/BOO.png', },
  { name: 'BOP/USDC', deprecated: true, address: new PublicKey('5xCudgPvVetTL3M4ExtPuAFTnCr2hdQ3cte9LhGAuBee'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/BOP.png', },
  { name: 'DROID/USDC', deprecated: true, address: new PublicKey('CFW3YFB4uN1NWFDYmcKmT9qA3iyi3L5Bz9QJNjKQAWeS'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/DROID.png', },
  { name: 'DUST/USDC', deprecated: true, address: new PublicKey('6uCCYVogMFvTjnSk3itNEAsVUmpJxj9F6kyTJwRTJy63'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/DUST.png', },
  ...
  { name: 'FLTH/USDC', deprecated: true, address: new PublicKey('HTHMfoxePjcXFhrV74pfCUNoWGe374ecFwiDjPGTkzHr'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/FLTH.png', },
  ...
  { name: 'FTR/USDC', deprecated: true, address: new PublicKey('9git3DawZThm3eCyj8Mr3Svq8u2Ce37UZMfeJRm2o2zj'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/FTR.png', },
  { name: 'LIKE/USDC', deprecated: true, address: new PublicKey('XSiwhjR4nQ9CenYXFN162Uk3ZR2njXCv5cvCsquyePL'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://s2.coinmarketcap.com/static/img/coins/64x64/1027.png', },
  { name: 'LUV/USDC', deprecated: true, address: new PublicKey('9UBuWgKN8ZYXcZWN67Spfp3Yp67DKBq1t31WLrVrPjTR'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/LUV.png', },
  ...
  { name: 'PIXL/USDC', deprecated: true, address: new PublicKey('DxRxLdAY54eFd8Hdym842pSpN9EGifXiAQQ1prLXEmdu'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/PIXL.png', },
  { name: 'PRT/USDC', deprecated: true, address: new PublicKey('BcmbQcG8E4Hu5KnFaqy58TjRkcsdtjfdWJVe9yC7gBjw'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/PRT.png', },
  { name: 'PUFF/USDC', deprecated: true, address: new PublicKey('FjkwTi1nxCa1S2LtgDwCU8QjrbGuiqpJvYWu3SWUHdrV'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/PUFF.png', },
  ...
  { name: 'SAMO/USDC', deprecated: true, address: new PublicKey('FR3SPJmgfRSKKQ2ysUZBu7vJLpzTixXnjzb84bY3Diif'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/SAMO.png', },
  ...
  { name: 'SOLGE/USDC', deprecated: true, address: new PublicKey('8WCzJpSNcLUYXPYeUDAXpH4hgqxFJpkYkVT6GJDSpcGx'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/SOLGE.png', },
  ...
  { name: 'xLFNTY/USDC', deprecated: true, address: new PublicKey('FjkwTi1nxCa1S2LtgDwCU8QjrbGuiqpJvYWu3SWUHdrV'), programId: new PublicKey('srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX'), image: 'https://dex.solape.io/icons/tokens/xLFNTY.png', },
