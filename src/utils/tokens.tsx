...
export const TOKENS: Tokens = {
  ...
  BONE: {
    symbol: 'BONE',
    name: 'BONE',
    mintAddress: 'D3eyBjfgJMPHZyYDRtbf1cSxeLiNwKumwHzQK3h3TRRq',
    decimals: 9,
  },
  WOOD: {
    symbol: 'WOOD',
  ...
  IMBA: {
    symbol: 'IMBA',
    name: 'IMBA',
    mintAddress: 'imbaePRPNVxBhTLdSWpdjYbXiPWc9spNTz4xKVkZfBJ',
    decimals: 9,
  },
  SCRAP: {
    symbol: 'SCRAP',
    name: 'SCRAP',
    mintAddress: '6naWDMGNWwqffJnnXFLBCLaYu1y5U9Rohe5wwJPHvf1p',
    decimals: 9,
  },
  BOKU: {
    symbol: 'BOKU',
  ...
  KRILL: {
    symbol: 'KRILL',
    name: 'KRILL',
    mintAddress: 'EP2aYBDD4WvdhnwWLUMyqU69g1ePtEjgYK6qyEAFCHTx',
    decimals: 9,
  },
  TINY: {
    symbol: 'TINY',
    name: 'TINY',
    mintAddress: 'C5xtJBKm24WTt3JiXrvguv7vHCe7CknDB7PNabp4eYX6',
    decimals: 9,
  },
  BOLT: {
    symbol: 'BOLT',
    name: 'BOLT',
    mintAddress: '4xDPH7DVtDXA2eU6wp9BjhryfXEdxBuhe4hnEc9yz1pJ',
    decimals: 9,
  },
  ALL: {
    symbol: 'ALL',
    name: 'ALL',
    mintAddress: '7ScYHk4VDgSRnQngAUtQk4Eyf7fGat8P4wXq6e2dkzLj',
    decimals: 9,
  },
  VITAL: {
    symbol: 'VITAL',
    name: 'VITAL',
    mintAddress: '2FKuYE5D75e9Fjg3ymGBrFfVc8tVKac4SeyvZn5dGNUz',
    decimals: 9,
  },
  LUX: {
    symbol: 'LUX',
    name: 'LUX',
    mintAddress: '3gb3iUAgTCtXq7cFiDZTi2GFPgQdg1zFVUubYAtLJfWU',
    decimals: 9,
  },
  SMU: {
    symbol: 'SMU',
    name: 'SMU',
    mintAddress: 'Eqekt4QF8zy9X6MZn5JUa6YYAz5MMgo7ZV5ZyX7YtjJW',
    decimals: 9,
  },
  FLWR: {
    symbol: 'FLWR',
  ...
  SLNT: {
    symbol: 'SLNT',
    name: 'SLNT',
    mintAddress: '78ZnfsncDVyhE2HVPe5LscUrgKsJpwP3wJDHRF2TuC1v',
    decimals: 9,
  },
  MBC: {
    symbol: 'MBC',
    name: 'MBC',
    mintAddress: 'AShCRr7fqsMf7ieM5AkJqNY566HsYmtvpvK8oPUL4Bh8',
    decimals: 9,
  },
  WHEY: {
    symbol: 'WHEY',
    name: 'WHEY',
    mintAddress: '5fTwKZP2AK39LtFN9Ayppu6hdCVKfMGVm79F2EgHCtsi',
    decimals: 9,
  },
  IV: {
    symbol: 'IV',
    name: 'IV',
    mintAddress: 'invSTFnhB1779dyku9vKSmGPxeBNKhdf7ZfGL1vTH3u',
    decimals: 9,
  },
  DAWG: {
    symbol: 'DAWG',
    name: 'DWAG',
    mintAddress: '3DHPqxdMXogNNnpqBMF8N4Zs4dn1WR31H7UjWq6FExwG',
    decimals: 9,
  },
  ...
  SWOLE: {
    symbol: 'SWOLE',
    name: 'SWOLE',
    mintAddress: '4BzxVoBQzwKoqm1dQc78r42Yby3EzAeZmMiYFdCjeu5Z',
    decimals: 9,
  },
  WSOL: {
    symbol: 'WSOL',
